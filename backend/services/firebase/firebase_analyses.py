...
class FireBaseAnalyses(FireBaseService):
    ...
    def save_analysis(self, analysis_id: str, details: dict, video_key: str, video_data: dict) -> str:
        """
    ...
    def mark_user_as_viewer(self, analysis_id: str, viewer_user_id: str) -> None:
        ...
        if doc.exists:
            ...
            if viewer_user_id == analysis_data.get("user_id"): return  # Owner is not added as viewer
