...
@pytest.fixture()
def issue_with_id(client, db_session):
...
def test_create_issue(client, db_session):
...
def test_create_issue_minimal_fields(client, db_session):
...
def test_get_issue(client, issue_with_id):
...
def test_get_all_issues(client, db_session):
...
def test_get_issues_by_analysis(client, db_session):
...
def test_get_issues_by_drill(client, db_session):
...
def test_update_issue(client, issue_with_id, db_session):
